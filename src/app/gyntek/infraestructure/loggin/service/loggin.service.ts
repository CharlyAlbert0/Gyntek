...
export class LogginService {
  ...
  constructor(private http: HttpClient,private _SystemContext:SystemContext ) { }
...
getLogs(): Observable<any> {
  let json = JSON.stringify(LogginModel);
...
AddLog( Message:string,
  ...
  clientLogError(error: ClientErrorModel): Observable<any>{
    let json = JSON.stringify(ClientErrorModel);
    let params = "json="+json;
    let headers = new HttpHeaders().set('Content-Type','application/x-www-form-urlencoded');
