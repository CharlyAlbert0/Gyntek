...
export class DialogsService {
    ...
    loadingdialog:MatDialogRef<LoadingDialog>;
    dialoginputRef:MatDialogRef<DialogInput>;
    dialogErrorRef:MatDialogRef<DialogError>;
    dialogDevelopRef:MatDialogRef<DialogDevelopComponent>;
    constructor(private dialog: MatDialog,private loading:MatDialog,private DialoginputSimple:MatDialog,private DialogErrorMD:MatDialog,private DialogDevelopMD:MatDialog) { }
